  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          backgroundImage:
            "linear-gradient(rgba(10,37,64,0.3) 1px, transparent 1px), linear-gradient(90deg, rgba(10,37,64,0.3) 1px, transparent 1px)",
      ...
      <div className="max-w-[1100px] w-full mx-auto px-6 relative z-10 flex flex-col items-center">
        ...
        >
          ...
          <div className="p-10 md:p-16 lg:p-20 text-center flex flex-col items-center relative z-10">
            ...
            >
              See a live demonstration with your own documents — not a scripted
              demo. Evaluate Crivo on a real matter before you commit.
            </motion.p>
