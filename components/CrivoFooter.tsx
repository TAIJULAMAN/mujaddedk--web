...
export default function CrivoFooter() {
  return (
    <footer className="bg-white border-t border-slate-200 pt-20 pb-12 relative overflow-hidden font-sans" id="about">
      ...
      <div className="max-w-[1400px] mx-auto px-6 md:px-8 relative z-10">
          ...
          <div className="max-w-md">
            <Link href="/" className="inline-block mb-6">
              <span className="text-[28px] font-[900] tracking-tight leading-none text-[#0A2540]">
                crivo<span className="text-[#3478F6]">.</span>legal
              </span>
            </Link>
            <p className="text-slate-600 text-[16px] leading-relaxed max-w-[340px] font-medium">
              eDiscovery managed services built on transparent pricing and honest technology.
            </p>
          </div>
        ...
        <div className="border-t border-slate-100 pt-10 flex flex-col md:flex-row justify-between items-center gap-6">
          <div className="flex gap-4 items-center bg-slate-50 px-4 py-2 rounded-full border border-slate-100">
            ...
            <span className="text-[12px] text-slate-600 font-bold uppercase tracking-wider">All systems operational</span>
          </div>
          
          <div className="flex flex-col md:flex-row items-center gap-6">
            <div className="flex items-center space-x-8">
              <a href="#" className="text-[13px] text-slate-500 hover:text-slate-900 font-bold transition-colors">Privacy Policy</a>
              <a href="#" className="text-[13px] text-slate-500 hover:text-slate-900 font-bold transition-colors">Terms of Service</a>
            </div>
